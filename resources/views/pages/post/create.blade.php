    ...
    <x-slot name="header">
        <h2 class="leading-tight">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item breadcrumb-active">Buat</li>
            </ol>
        </h2>
    </x-slot>
                ...
                <div class="max-w-xl">
                    <form method="post" action="{{ route('post.store') }}" class="mt-6 space-y-6"
                        ...
                        <div>
                            ...
                            <img src="{{ asset('assets/images/default-image.jpg') }}" alt="Preview Image"
                                class="aspect-[4/3] object-cover w-full" id="preview-img">
                        </div>
                        ...
                        <div>
                            <div class="w-full">
                                ...
                                <input id="image"
                                    ...
                                    type="file" accept="image/png, image/jpg, image/jpeg" name="image" required
                        ...
                        <div>
                            ...
                            <div class="flex flex-row flex-wrap gap-x-3 gap-y-2 mt-1">
                                @foreach ($categories as $id => $name)
                                    <div>
                                        <input type="checkbox" id="category-{{ $id }}" name="categories[]" value="{{ $id }}" class="hidden peer">
                                        <label for="category-{{ $id }}"
                                            ...
                                            <div class="block">
                                                <div class="w-full text-sm font-semibold">{{ $name }}</div>
                                            </div>
                                        </label>
                                    </div>
                                @endforeach
                        ...
                        <div>
                            ...
                            <x-textarea id="preview" class="mt-1 block w-full"
                                name="preview">{{ old('preview') }}</x-textarea>
